...
ifneq ($(BINARY_VERSION),)
	LDFLAGS += -X github.com/ntnguyencse/helm-mod/internal/version.version=${BINARY_VERSION}
endif
...
LDFLAGS += -X github.com/ntnguyencse/helm-mod/internal/version.metadata=${VERSION_METADATA}
LDFLAGS += -X github.com/ntnguyencse/helm-mod/internal/version.gitCommit=${GIT_COMMIT}
LDFLAGS += -X github.com/ntnguyencse/helm-mod/internal/version.gitTreeState=${GIT_DIRTY}
LDFLAGS += $(EXT_LDFLAGS)
...
LDFLAGS += -X github.com/ntnguyencse/helm-mod/pkg/lint/rules.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/ntnguyencse/helm-mod/pkg/lint/rules.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
LDFLAGS += -X github.com/ntnguyencse/helm-mod/pkg/chartutil.k8sVersionMajor=$(K8S_MODULES_MAJOR_VER)
LDFLAGS += -X github.com/ntnguyencse/helm-mod/pkg/chartutil.k8sVersionMinor=$(K8S_MODULES_MINOR_VER)
